...
{
    [MAPSEC_LAULEV_TOWN] = {MAP_GROUP(LAULEV_TOWN), MAP_NUM(LAULEV_TOWN), HEAL_LOCATION_LAULEV_TOWN_BRENDANS_HOUSE_2F},
    ...
    [MAPSEC_LAULEV_WOODS] = {MAP_GROUP(LAULEV_WOODS), MAP_NUM(LAULEV_WOODS), HEAL_LOCATION_NONE},
    [MAPSEC_LAULEV_CANYON] = {MAP_GROUP(LAULEVCANYON), MAP_NUM(LAULEVCANYON), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_LAULEV_TOWN:
        return FlagGet(FLAG_VISITED_LAULEV_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_LAULEV_TOWN;
    for (mapSecId = MAPSEC_LAULEV_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
        ...
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                case MAPSEC_BATTLE_FRONTIER:
                    ...
                    break;
                case MAPSEC_LAULEV_TOWN:
                    SetWarpDestinationToHealLocation(gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_LAULEV_TOWN_BRENDANS_HOUSE : HEAL_LOCATION_LAULEV_TOWN_MAYS_HOUSE);
                    break;
                case MAPSEC_EVER_GRANDE_CITY:
