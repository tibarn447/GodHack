...
{
    [HEAL_LOCATION_LAULEV_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(LAULEV_TOWN_BRENDANS_HOUSE_2F), MAP_NUM(LAULEV_TOWN_BRENDANS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_LAULEV_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(LAULEV_TOWN_MAYS_HOUSE_2F), MAP_NUM(LAULEV_TOWN_MAYS_HOUSE_2F), 4, 2},
    ...
    [HEAL_LOCATION_LAULEV_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LAULEV_TOWN), MAP_NUM(LAULEV_TOWN), 10, 17},
    [HEAL_LOCATION_LAULEV_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LAULEV_TOWN), MAP_NUM(LAULEV_TOWN), 19, 14},
