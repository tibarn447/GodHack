static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_Laulev_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(Laulev_TOWN), MAP_NUM(Laulev_TOWN), 9, 9},
    [HEAL_LOCATION_Laulev_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(Laulev_TOWN), MAP_NUM(Laulev_TOWN), 18, 9},
