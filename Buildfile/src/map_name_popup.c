...
{
    [MAPSEC_LAULEV_TOWN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_LAULEV_WOODS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAULEV_CANYON] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_CHATOT_TOWER] = MAPPOPUP_THEME_WOOD
};
