...
const u8 gText_Laulev[] = _("Laulev"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_MonkePansear[] = _("Pansear");
//const u8 gText_MonkePanpour[] = _("Panpour");
//const u8 gText_MonkePansage[] = _("Pansage");
