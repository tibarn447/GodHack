...
static const u8 sDoorAnimTiles_Laulev[] = INCBIN_U8("graphics/door_anims/Laulev.4bpp");
...
static const u8 sDoorAnimPalettes_Laulev[] = {10, 10, 6, 6, 6, 6, 6, 6};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Petalburg_Door_Laulev,                    DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Laulev, sDoorAnimPalettes_Laulev},
